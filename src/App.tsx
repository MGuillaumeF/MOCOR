  ...
  return (
    <div className="App">
      <header className="App-header">
        <Meter value={state} max={10} bgMeterColor="#222" />
        <InputText
          id="essai-1"
          label="update gauge"
          value={state}
        ...
        <Button id="button-test" type="submit">
          Test
        </Button>
        <Button id="button-test" type="submit" level="primary">
          Test
        </Button>
        <Button id="button-test" type="submit" level="secondary">
          Test
        </Button>
        <Button id="button-test" type="submit" level="tertiary">
          Test
        </Button>
      </header>
    </div>
